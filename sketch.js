...
function draw() {
  ...
  if(gameState==="PLAY")
  {
    ...
    textSize(20);
    text("Click anywhere to make the ball fall down for points. **Remember you only have 5 chances**. Good Luck!!",180,30);
  ...
  else if (gameState==="END")
  {
    ...
    textSize(20);
    text("Nice try! Press SPACE to try again :-).",00,400);
    if(keyIsDown(32))
    {
      gameState="PLAY";
      turn=0;
